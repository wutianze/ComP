...
(cl:defmethod cl:initialize-instance :after ((m <Test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_pkg-msg:<Test> is deprecated: use example_pkg-msg:Test instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_pkg-msg:header-val is deprecated.  Use example_pkg-msg:header instead.")
  (header m))
