...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name example_pkg-msg:<Num> is deprecated: use example_pkg-msg:Num instead.")))

(cl:ensure-generic-function 'content-val :lambda-list '(m))
(cl:defmethod content-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_pkg-msg:content-val is deprecated.  Use example_pkg-msg:content instead.")
  (content m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_pkg-msg:id-val is deprecated.  Use example_pkg-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader example_pkg-msg:timestamp-val is deprecated.  Use example_pkg-msg:timestamp instead.")
  (timestamp m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Num>)))
  ...
  "34f0a63c6019bc102c58640902c234e7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Num)))
  "Returns md5sum for a message object of type 'Num"
  "34f0a63c6019bc102c58640902c234e7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "string content~%int64 id~%int64 timestamp~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "string content~%int64 id~%int64 timestamp~%~%~%"))
