...
(cl:defmethod cl:initialize-instance :after ((m <Test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_s-msg:<Test> is deprecated: use simple_s-msg:Test instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_s-msg:header-val is deprecated.  Use simple_s-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'content-val :lambda-list '(m))
(cl:defmethod content-val ((m <Test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_s-msg:content-val is deprecated.  Use simple_s-msg:content instead.")
  (content m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simple_s-msg:id-val is deprecated.  Use simple_s-msg:id instead.")
  (id m))
