...
(cl:ensure-generic-function 'deliver_time-val :lambda-list '(m))
(cl:defmethod deliver_time-val ((m <TestImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader detect_s-msg:deliver_time-val is deprecated.  Use detect_s-msg:deliver_time instead.")
  (deliver_time m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TestImage>) ostream)
  ...
  (cl:let ((__sec (cl:floor (cl:slot-value msg 'deliver_time)))
        (__nsec (cl:round (cl:* 1e9 (cl:- (cl:slot-value msg 'deliver_time) (cl:floor (cl:slot-value msg 'deliver_time)))))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TestImage>) istream)
  "Deserializes a message object of type '<TestImage>"
    (cl:let ((__sec 0) (__nsec 0))
      ...
      (cl:setf (cl:slot-value msg 'deliver_time) (cl:+ (cl:coerce __sec 'cl:double-float) (cl:/ __nsec 1e9))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TestImage>)))
  ...
  "f3cdf94aed878ccdf3efa835405364a9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TestImage)))
  "Returns md5sum for a message object of type 'TestImage"
  "f3cdf94aed878ccdf3efa835405364a9")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TestImage>))
  ...
  (cl:list 'TestImage
    (cl:cons ':deliver_time (deliver_time msg))
