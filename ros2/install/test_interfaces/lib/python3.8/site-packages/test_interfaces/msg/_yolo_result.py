    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'test_interfaces.msg.YoloResult')
            logger.debug(
            ...
            from test_interfaces.msg import YoloPiece
...
class YoloResult(metaclass=Metaclass_YoloResult):
    ...
    _fields_and_field_types = {
        ...
        'result_num': 'uint32',
        'result_array': 'sequence<test_interfaces/YoloPiece>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['test_interfaces', 'msg'], 'YoloPiece')),  # noqa: E501
    )
