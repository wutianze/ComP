...
bool test_interfaces__msg__yolo_piece__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_interfaces.msg._yolo_piece.YoloPiece", full_classname_dest, 41) == 0);
  }
  test_interfaces__msg__YoloPiece * ros_message = _ros_message;
  {  // x
  ...
  {  // w
    ...
    assert(PyLong_Check(field));
    ros_message->w = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // h
    ...
    assert(PyLong_Check(field));
    ros_message->h = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // prob
  ...
  {  // obj_id
    ...
    assert(PyFloat_Check(field));
    ros_message->obj_id = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // track_id
    ...
    assert(PyFloat_Check(field));
    ros_message->track_id = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // frames_counter
    ...
    assert(PyFloat_Check(field));
    ros_message->frames_counter = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * test_interfaces__msg__yolo_piece__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_interfaces.msg._yolo_piece");
  ...
  test_interfaces__msg__YoloPiece * ros_message = (test_interfaces__msg__YoloPiece *)raw_ros_message;
  {  // x
    PyObject * field = NULL;
  ...
  {  // obj_id
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->obj_id);
    {
  ...
  {  // track_id
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->track_id);
    {
  ...
  {  // frames_counter
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->frames_counter);
    {
