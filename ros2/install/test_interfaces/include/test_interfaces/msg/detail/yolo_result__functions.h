...
#ifndef TEST_INTERFACES__MSG__DETAIL__YOLO_RESULT__FUNCTIONS_H_
#define TEST_INTERFACES__MSG__DETAIL__YOLO_RESULT__FUNCTIONS_H_
 ...
 * calls
 * test_interfaces__msg__YoloResult__init().
...
/**
 * It calls
 * test_interfaces__msg__YoloResult__fini()
 ...
 * test_interfaces__msg__YoloResult__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * test_interfaces__msg__YoloResult__Sequence__fini()
 * on the array,
...
#endif  // TEST_INTERFACES__MSG__DETAIL__YOLO_RESULT__FUNCTIONS_H_
