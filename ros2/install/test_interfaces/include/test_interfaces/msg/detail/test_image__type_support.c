...
static rosidl_typesupport_introspection_c__MessageMember TestImage__rosidl_typesupport_introspection_c__TestImage_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(test_interfaces__msg__TestImage, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(test_interfaces__msg__TestImage, image_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces, msg, TestImage)() {
  TestImage__rosidl_typesupport_introspection_c__TestImage_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  TestImage__rosidl_typesupport_introspection_c__TestImage_message_member_array[3].members_ =
