...
bool simple_s__msg__test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("simple_s.msg._test.Test", full_classname_dest, 23) == 0);
  }
  simple_s__msg__Test * ros_message = _ros_message;
  {  // header
...
PyObject * simple_s__msg__test__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("simple_s.msg._test");
