...
#include <stddef.h>
#include "simple_s/msg/detail/test__rosidl_typesupport_introspection_c.h"
#include "simple_s/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember Test__rosidl_typesupport_introspection_c__Test_message_member_array[3] = {
  {
    ...
    offsetof(simple_s__msg__Test, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simple_s__msg__Test, content),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(simple_s__msg__Test, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test__rosidl_typesupport_introspection_c__Test_message_members = {
  "simple_s__msg",  // message namespace
  "Test",  // message name
  3,  // number of fields
  sizeof(simple_s__msg__Test),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_simple_s
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, simple_s, msg, Test)() {
