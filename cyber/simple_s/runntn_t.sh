...
ps_num=8
log_dir="/apollo/data/log/test/ttest"$ps_num"t"$ps_num"_8_ci"
rm -rf $log_dir
mkdir $log_dir
...
# launch
cyber_launch start /apollo/cyber/AD_Middle_Test/cyber/simple_s/ntn_t.launch & #./bazel-bin/cyber/AD_Middle_Test/cyber/intra_no_component $2 &
sleep 300
cyber_launch stop
sleep 20
