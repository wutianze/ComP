...
ps_num=4
log_dir="/apollo/data/log/test/"$ps_num"t1_100_50_20_10_cs"
rm -rf $log_dir
mkdir $log_dir
...
cp /apollo/cyber/AD_Middle_Test/cyber/simple_s/nt1*.conf /apollo/cyber/conf/ 
...
# launch
cyber_launch start /apollo/cyber/AD_Middle_Test/cyber/simple_s/nt1_p.launch & #./bazel-bin/cyber/AD_Middle_Test/cyber/intra_no_component $2 &
sleep 300
cyber_launch stop
sleep 20
...
do
	...
	mv /apollo/data/log/test/tmp/$f $log_dir/$f"_"$ps_num"t1_100_50_20_10_cs.csv"
done
done
